...
var translate = function (plugin) { return ({
    /*
    ...
    getTranslation: function (msgid, n, context, defaultPlural, language) {
        ...
        var silent = plugin ? ((_a = plugin.options) === null || _a === void 0 ? void 0 : _a.silent) || plugin.options.muteLanguages.indexOf(language) !== -1 : false;
        // Default untranslated string, singular or plural.
        var untranslated = defaultPlural && plurals_1.default.getTranslationIndex(language, n) > 0 ? defaultPlural : msgid;
        ...
        var pluginTranslations = plugin.options.translations;
        var translations = pluginTranslations[language] || pluginTranslations[language.split("_")[0]];
        if (!translations) {
            if (!silent) {
        ...
        var translationIndex = plurals_1.default.getTranslationIndex(language, n);
