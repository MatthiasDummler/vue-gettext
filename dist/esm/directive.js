...
var updateTranslation = function (plugin, el, binding, vnode) {
    ...
    var translation = translate(plugin).getTranslation(msgid, translateN, translateContext, isPlural ? translatePlural : null, el.dataset.currentLanguage);
    var context = Object.assign(binding.instance, binding.value);
    var msg = interpolate(plugin)(translation, context, null, disableHtmlEscaping);
    el.innerHTML = msg;
};
/**
 ...
 */
export default function directive(plugin) {
